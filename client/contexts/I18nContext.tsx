...
const translations: Record<Lang, Dict> = {
  ...
  wo: {
    ...
    "features.platformDesc":
      "Tekinoloojitti haaroi, heezzoassi azazanchuwassi gakkana. Qeyyanna woyyadanai, wossanchuwaa, kaaccuwaa qoppeessuwan baalaa ubbai berdiya.",
    "roles.designedFor": "Hakkane Dargaassi Dargaassi Gaamanko",
    "roles.designedForDesc":
      "Heezzo miishshai wogaassi gaamankuwaa erissi, shishshi wottido.",
    ...
    "cta.subheading":
      "Amanuwaa woyyadanai koyyite. Shishsha gaamanchuwaassi case taaxxissuwaa, report qophissuwaa, woyyadanai qoppeessu.",
