...
export default function StaffManagement() {
  ...
  const canAssignStaff = hasAnyRole([
    UserRole.SUPER_ADMIN,
    UserRole.POLICE_HEAD,
  ]);
  ...
  const staffStats = {
    ...
    detectives: staff.filter(
      (s) => s.role === UserRole.DETECTIVE_OFFICER && s.isActive,
    ).length,
    officers: staff.filter(
      (s) => s.role === UserRole.PREVENTIVE_OFFICER && s.isActive,
    ).length,
  };
      ...
      <div className="bg-crime-black text-white p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-300">
            Officer supervision, assignment, and workforce management
          </p>
        </div>
      </div>
                  ...
                  {filteredStaff.map((member) => (
                    ...
                    >
                      <CardContent className="p-6">
                        ...
                        <h3 className="text-lg font-semibold text-crime-black mb-2">
                          {member.fullName}
                        </h3>
              ...
              <CardHeader>
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <CardDescription>
                      Current officer assignments and duties
                    </CardDescription>
                  </div>
                  {canAssignStaff && (
                ...
                <div className="space-y-4">
                  ...
                  {assignments.length === 0 && (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500">
                        Create new assignments to manage staff duties
                      </p>
                    </div>
                  )}
                </div>
