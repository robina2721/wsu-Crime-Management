...
export default function MyCases() {
  ...
  const fetchMyCases = async () => {
    try {
      ...
      const reports: CrimeReport[] = (data?.data?.reports || []).map(
        (r: any) => ({
          ...r,
  ...
  const caseStats = {
    ...
    active: cases.filter((c) =>
      [CrimeStatus.ASSIGNED, CrimeStatus.UNDER_INVESTIGATION].includes(
        c.status,
      ),
    ).length,
        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-gray-600">
              You don't have permission to view case assignments.
            </p>
          </CardContent>
        </Card>
      </div>
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-xl font-semibold text-crime-black">
                          {case_.title}
                        </h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm text-gray-600 mb-4">
                        ...
                        <div className="flex items-center">
                          ...
                          Incident:{" "}
                          {new Date(case_.dateIncident).toLocaleDateString()}
                        </div>
                        <div className="flex items-center">
                      ...
                      <div className="flex gap-2 mb-4">
                        <Dialog
                          open={
                            isDetailsDialogOpen && selectedCase?.id === case_.id
                          }
                          onOpenChange={(open) => {
                                ...
                                <Card>
                                  ...
                                  <CardContent>
                                    <div className="text-center py-8 text-gray-500">
                                      ...
                                      <p>
                                        Investigation notes feature would be
                                        implemented here
                                      </p>
                                    </div>
                                  </CardContent>
