        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              type="date"
              value={
                reportParams.dateRange?.startDate
                  ?.toISOString()
                  .split("T")[0] || ""
              }
              onChange={(e) =>
          ...
          <div>
            ...
            <Input
              ...
              type="date"
              value={
                reportParams.dateRange?.endDate?.toISOString().split("T")[0] ||
                ""
              }
              onChange={(e) =>
                setReportParams((prev) => ({
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-4 flex-1">
                    <div className="mt-1">{getReportTypeIcon(report.type)}</div>
                    <div className="flex-1">
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="max-w-2xl">
                        ...
                        <div className="space-y-6">
                          ...
                          {report.parameters.departments &&
                            report.parameters.departments.length > 0 && (
                              <div>
                                <Label>Departments</Label>
                          ...
                          {report.parameters.ranks &&
                            report.parameters.ranks.length > 0 && (
                              <div>
                                <Label>Ranks</Label>
                                <div className="flex flex-wrap gap-2 mt-2">
              ...
              <form
                onSubmit={(e) => {
                  ...
                  handleGenerateReport(
                    ...
                    reportParams,
                    reportParams.title ||
                      `${selectedReportType.replace("_", " ").toUpperCase()} Report`,
                    reportParams.description ||
                      `Generated ${selectedReportType.replace("_", " ")} report`,
                  );
                }}
              >
                {renderReportForm()}
                ...
                <div className="flex justify-between items-center mt-6 pt-6 border-t">
                  ...
                  <div className="flex gap-4">
                    ...
                    <Button
                      ...
                      disabled={
                        !reportParams.dateRange?.startDate ||
                        !reportParams.dateRange?.endDate
                      }
                    >
                      Generate Report
                    </Button>
