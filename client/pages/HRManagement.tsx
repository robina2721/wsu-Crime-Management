...
export default function HRManagement() {
  ...
  const [selectedOfficer, setSelectedOfficer] = useState<OfficerProfile | null>(
    null,
  );
  ...
  const handleCreateEmployee = (data: Partial<OfficerProfile>) => {
    const newOfficer: OfficerProfile = {
      ...
      employeeId:
        data.employeeId || `EMP${String(officers.length + 1).padStart(3, "0")}`,
      personalInfo: {
      ...
      professionalInfo: {
        badgeNumber:
          data.professionalInfo?.badgeNumber ||
          `BADGE${String(officers.length + 1).padStart(3, "0")}`,
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span>
                      {officer.professionalInfo.department
                        .replace("_", " ")
                        .toUpperCase()}
                    </span>
                  </div>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex gap-1">
                    {officer.professionalInfo.certifications.map(
                      (cert, index) => (
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                      <DialogHeader>
                        <DialogTitle>
                          Officer Profile - {officer.personalInfo.fullName}
                        </DialogTitle>
                      </DialogHeader>
                        ...
                        <TabsContent value="personal" className="space-y-4">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <Input
                                value={officer.personalInfo.fullName}
                                readOnly
                              />
                            </div>
                            <div>
                              ...
                              <Input
                                value={officer.personalInfo.dateOfBirth.toLocaleDateString()}
                                readOnly
                              />
                            </div>
                            <div>
                              ...
                              <Input
                                value={officer.personalInfo.nationalId}
                                readOnly
                              />
                            </div>
                            <div>
                              <Label>Phone</Label>
                              <Input
                                value={officer.personalInfo.phone}
                                readOnly
                              />
                            </div>
                            <div className="col-span-2">
                              <Label>Email</Label>
                              <Input
                                value={officer.personalInfo.email}
                                readOnly
                              />
                            </div>
                            <div className="col-span-2">
                              <Label>Address</Label>
                              <Textarea
                                value={officer.personalInfo.address}
                                readOnly
                              />
                            </div>
                          </div>
                          <div>
                            ...
                            <div className="grid grid-cols-3 gap-4">
                              <div>
                                ...
                                <Input
                                  value={
                                    officer.personalInfo.emergencyContact.name
                                  }
                                  readOnly
                                />
                              </div>
                              <div>
                                ...
                                <Input
                                  value={
                                    officer.personalInfo.emergencyContact
                                      .relationship
                                  }
                                  readOnly
                                />
                              ...
                              <div>
                                ...
                                <Input
                                  value={
                                    officer.personalInfo.emergencyContact.phone
                                  }
                                  readOnly
                                />
                              </div>
                        ...
                        <TabsContent value="professional" className="space-y-4">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <Input
                                value={officer.professionalInfo.badgeNumber}
                                readOnly
                              />
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <Input
                                value={officer.professionalInfo.department
                                  .replace("_", " ")
                                  .toUpperCase()}
                                readOnly
                              />
                            ...
                            <div>
                              ...
                              <Input
                                value={officer.professionalInfo.startDate.toLocaleDateString()}
                                readOnly
                              />
                            </div>
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                {getStatusBadge(
                                  officer.professionalInfo.status,
                                )}
                              </div>
                            </div>
                            <div>
                              ...
                              <Input
                                value={
                                  officer.professionalInfo.supervisor ||
                                  "Not assigned"
                                }
                                readOnly
                              />
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                              {officer.professionalInfo.specializations.map(
                                (spec, index) => (
        ...
        >
          <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new employee profile with personal and professional
                information
              </DialogDescription>
            </DialogHeader>
            <form
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        required
                        value={
                          formData.professionalInfo?.startDate
                            ?.toISOString()
                            .split("T")[0] || ""
                        }
                        onChange={(e) =>
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-600 mb-4">
                No officers match your current search criteria.
              </p>
              <Button
                variant="outline"
                onClick={() => {
